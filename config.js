...
const CONFIG = {
  ...
  // (5) รายชื่อพนักงาน
  EMPLOYEES: ['น้องเบล', 'น้องมาริ', 'น้องคุกกี้', 'น้องน้ำปิง', 'น้องกระต่าย', 'น้องฮาย', 'น้องมะนาว', 'น้องฟ้าใส', 'น้องแคท', 'น้องสมศรี', 'น้องตะวัน', 'สไปเดอร์แมน', 'น้องปาล์มมี', 'น้องมารีน่า', 'น้องจูราสสิค'],
